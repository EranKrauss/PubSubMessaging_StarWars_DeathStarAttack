...
public abstract class MicroService implements Runnable { 
    ...
    private String name;
    private HashMap<Class , Callback> functionAndsType;
    ...
    public MicroService(String name) {
    	...
    	this.name = name;
    	this.functionAndsType = new HashMap<Class, Callback>();
    ...
    protected final <T, E extends Event<T>> void subscribeEvent(Class<E> type, Callback<E> callback) {
    	if(!this.functionAndsType.containsKey(type)){
    	    this.functionAndsType.put(type , callback);
        }
    	else{
    	    this.functionAndsType.replace(type , callback);
        }
    ...
    public final void run() {
        ...
        while(!this.isTerminate){
            try {
                ...
                functionAndsType.get(m.getClass()).call(m);
            } catch (InterruptedException e) {
                e.printStackTrace();
            }
        }

        messageBus.unregister(this);      //TODO
